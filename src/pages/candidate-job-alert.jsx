...
function Candidatejobalert(){
  ...
  <main className="main">
    ...
    <div className="site-breadcrumb">
      <div className="container">
        <h2 className="breadcrumb-title">Job Alerts</h2>
        <ul className="breadcrumb-menu">
          <li>
            <a href="/">Home</a>
          </li>
          <li className="active">Job Alerts</li>
        </ul>
      </div>
          ...
          <div className="col-lg-3">
            <div className="user-profile-sidebar">
              ...
              <ul className="user-profile-sidebar-list">
                ...
                <li>
                  <a className="active" href="candidate-job-alert">
            ...
            <div className="user-profile-wrapper">
              <div className="col-lg-12">
                <div className="user-profile-card">
                  <h4 className="user-profile-card-title">Job Alerts (05)</h4>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            >
                              <i className="far fa-eye" /> Mark As Read
                            </a>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <a
                              ...
                              className="btn btn-outline-secondary btn-sm"
                            >
                              <i className="far fa-eye-slash" /> Mark As Unread
                            </a>
                          </td>
                        </tr>
                        <tr>
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="footer-widget-box about-us">
              ...
              <ul className="footer-contact">
                ...
                <li>
                  <a href="/cdn-cgi/l/email-protection#ec85828a83ac89948d819c8089c28f8381">
