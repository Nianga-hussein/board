    ...
    return(
        ...
        <main className="main">
          ...
          <div className="site-breadcrumb">
            <div className="container">
              <h2 className="breadcrumb-title">Post A Job</h2>
              <ul className="breadcrumb-menu">
                <li>
                  <a href="/">Home</a>
                </li>
                <li className="active">Post A Job</li>
              </ul>
            </div>
                ...
                <div className="col-lg-3">
                  <div className="user-profile-sidebar">
                    ...
                    <ul className="user-profile-sidebar-list">
                      ...
                      <li>
                        <a className="active" href="employer-post-job">
                          <i className="far fa-paper-plane" /> Post A Job
                        </a>
                      </li>
                      <li>
                ...
                <div className="col-lg-9">
                  <div className="user-profile-wrapper">
                    <div className="user-profile-card">
                      <h4 className="user-profile-card-title">Post Job</h4>
                              ...
                              <div className="col-md-12">
                                <div className="form-group mt-3">
                                  <button type="submit" className="theme-btn">
                                    <span className="far fa-check-circle" /> Publish
                                    Your Job
                                  </button>
                                </div>
                              </div>
                ...
                <div className="col-md-6 col-lg-4 col-xl-3">
                  <div className="footer-widget-box about-us">
                    ...
                    <ul className="footer-contact">
                      ...
                      <li>
                        <a href="/cdn-cgi/l/email-protection#91f8fff7fed1f4e9f0fce1fdf4bff2fefc">
                          <i className="far fa-envelope" />
                          <span
                            className="__cf_email__"
                            data-cfemail="dfb6b1b9b09fbaa7beb2afb3baf1bcb0b2"
                          >
                            [email&nbsp;protected]
                          </span>
                        </a>
