...
function  Candidateshortlistedjob(){
    return(
        <>
        {/* preloader */}
        ...
        <main className="main">
          ...
          <div className="site-breadcrumb">
            <div className="container">
              <h2 className="breadcrumb-title">Shortlisted Jobs</h2>
              <ul className="breadcrumb-menu">
                <li>
                  <a href="/">Home</a>
                </li>
                <li className="active">Shortlisted Jobs</li>
              </ul>
            </div>
                ...
                <div className="col-lg-3">
                  <div className="user-profile-sidebar">
                    ...
                    <ul className="user-profile-sidebar-list">
                      ...
                      <li>
                        <a className="active" href="candidate-shortlisted-job">
                ...
                <div className="col-lg-9">
                  <div className="user-profile-card">
                    <div className="user-profile-card-header">
                      <h4 className="user-profile-card-title">Shortlisted Jobs</h4>
                    ...
                    <div className="table-responsive profile-applied-job">
                          ...
                          <tr>
                            <td>
                              <div className="profile-job-info">
                                ...
                                <div className="profile-job-content">
                                  <h6>
                                    <a href="/">Senior Product Designer</a>
                                  </h6>
                                  <ul className="profile-job-list">
                                    <li>
                                      <i className="far fa-briefcase" /> Circle Pixel
                                    </li>
                                    <li>
                                      <i className="far fa-location-dot" /> New York,
                                      USA
                                    </li>
                                  </ul>
                                </div>
                            ...
                            <td>
                              ...
                              >
                                <i className="far fa-download" /> Download CV
                              </a>
                            </td>
                            <td>
                ...
                <div className="col-md-6 col-lg-4 col-xl-3">
                  <div className="footer-widget-box about-us">
                    ...
                    <ul className="footer-contact">
                      ...
                      <li>
                        <a href="/cdn-cgi/l/email-protection#365f58505976534e575b465a531855595b">
...
export default  Candidateshortlistedjob 