...
function Employerprofile(){
  ...
  <main className="main">
    ...
    <div className="site-breadcrumb">
      <div className="container">
        <h2 className="breadcrumb-title">Company Profile</h2>
          ...
          <div className="col-lg-3">
            <div className="user-profile-sidebar">
              ...
              <ul className="user-profile-sidebar-list">
                ...
                <li>
                  <a className="active" href="employer-profile">
                    <i className="far fa-user-tie" /> Company Profile
                  </a>
                </li>
                <li>
          ...
          <div className="col-lg-9">
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Company Basic Info</h4>
                <div className="row g-5">
                  <div className="col-lg-6">
                    <div className="profile-info-list">
                      <ul>
                        <li>
                          Company Name: <span>Rubic Corner</span>
                        </li>
                        <li>
                          Email:{" "}
                          <span>
                            <a
                              ...
                              data-cfemail="017374636862626e736f6473416479606c716d642f626e6c"
                            >
                              [email&nbsp;protected]
                            </a>
                          </span>
                        ...
                        <li>
                          Company Website: <span>www.example.com</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="profile-info-list">
                      <ul>
                        <li>
                          Team Size: <span>50 - 100</span>
                        </li>
                        <li>
                          Established: <span>1990</span>
                        </li>
                        <li>
                          Primary Industry: <span>IT &amp; Software</span>
                        </li>
                        <li>
            ...
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">About Company</h4>
                ...
                <div className="col-lg-6">
                  <div className="profile-info-list">
                    <ul>
                      ...
                      <li>
                        Full Address:{" "}
                        <span>25/B Milford Road, AZ 85001, Brazzaville</span>
                      </li>
                    </ul>
                  </div>
                </div>
