          ...
          <div className="col-lg-3">
            <div className="user-profile-sidebar">
              ...
              <ul className="user-profile-sidebar-list">
                ...
                <li>
                  <a className="active" href="candidate-profile">
                    <i className="far fa-user-tie" /> My Profile
                  </a>
                </li>
                <li>
          ...
          <div className="col-lg-9">
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Profile Basic Info</h4>
                <div className="row g-5">
                  <div className="col-lg-6">
                    <div className="profile-info-list">
                      <ul>
                        <li>
                          Full Name: <span>Laura Packer</span>
                        </li>
                        <li>
                          Email:{" "}
                          <span>
                            <a
                              ...
                              data-cfemail="214d405453405140424a4453614459404c514d440f424e4c"
                            >
                              [email&nbsp;protected]
                            </a>
                          </span>
                        ...
                        <li>
                          Contact Number: <span>+2 134 562 458</span>
                        </li>
                        <li>
                          Personal Website: <span>www.example.com</span>
                        </li>
                        <li>
                        ...
                        <li>
                          Join Date: <span>21 August, 2024</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="profile-info-list">
                      <ul>
                        <li>
                          Education Level: <span>Master Degree</span>
                        </li>
                        <li>
                          Language: <span>English, German</span>
                        </li>
                        <li>
                          Job Category: <span>IT &amp; Software</span>
                        </li>
                        <li>
                          Date Of Birth: <span>21 August, 1986</span>
                        </li>
                        <li>
                          Experience: <span>04 Years</span>
                        </li>
                        <li>
                          Current Salary: <span>$50k - $60k</span>
                        </li>
                        <li>
                          Expected Salary: <span>$70k - $85k</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Skills</h4>
            ...
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Bio</h4>
                <div className="col-lg-12">
            ...
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Contact Info</h4>
                <div className="col-lg-6">
                  <div className="profile-info-list">
                    <ul>
                      <li>
                      ...
                      <li>
                        State: <span>Arizona</span>
                      </li>
                      <li>
                        Zip Code: <span>85001</span>
                      </li>
                      <li>
                        Full Address:{" "}
                        <span>25/B Milford Road, AZ 85001, New York, USA</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="user-profile-wrapper">
              <div className="user-profile-card">
                <h4 className="user-profile-card-title">Social Network</h4>
                <div className="col-lg-6">
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="footer-widget-box about-us">
              ...
              <ul className="footer-contact">
                ...
                <li>
                  <a href="/cdn-cgi/l/email-protection#21484f474e614459404c514d440f424e4c">
                    <i className="far fa-envelope" />
                    <span
                      className="__cf_email__"
                      data-cfemail="4a23242c250a2f322b273a262f64292527"
                    >
                      [email&nbsp;protected]
                    </span>
                  </a>
