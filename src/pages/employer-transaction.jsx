...
function Employertransaction(){
  ...
  <main className="main">
    ...
    <div className="site-breadcrumb">
      <div className="container">
        <h2 className="breadcrumb-title">Transaction</h2>
        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="user-profile-sidebar">
              ...
              <ul className="user-profile-sidebar-list">
                ...
                <li>
                  <a className="active" href="employer-transaction">
          ...
          <div className="col-lg-9">
            <div className="user-profile-card">
              <h4 className="user-profile-card-title">Transaction</h4>
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="footer-widget-box about-us">
              ...
              <ul className="footer-contact">
                ...
                <li>
                  <a href="/cdn-cgi/l/email-protection#5b32353d341b3e233a362b373e75383436">
