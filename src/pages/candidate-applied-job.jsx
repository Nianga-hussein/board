...
function Candidateappliedjob (){
  ...
  <main className="main">
    ...
    <div className="site-breadcrumb">
      <div className="container">
        <h2 className="breadcrumb-title">Applied Jobs</h2>
          ...
          <div className="col-lg-3">
            <div className="user-profile-sidebar">
              ...
              <ul className="user-profile-sidebar-list">
                ...
                <li>
                  <a className="active" href="candidate-applied-job">
                    <i className="far fa-briefcase" /> Applied Jobs
                  </a>
                </li>
                <li>
          ...
          <div className="col-lg-9">
            <div className="user-profile-card">
              <div className="user-profile-card-header">
                <h4 className="user-profile-card-title">Applied Jobs</h4>
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="footer-widget-box about-us">
              ...
              <ul className="footer-contact">
                ...
                <li>
                  <a href="/cdn-cgi/l/email-protection#bdd4d3dbd2fdd8c5dcd0cdd1d893ded2d0">
                    <i className="far fa-envelope" />
                    <span
                      className="__cf_email__"
                      data-cfemail="670e09010827021f060a170b024904080a"
                    >
                      [email&nbsp;protected]
                    </span>
                  </a>
