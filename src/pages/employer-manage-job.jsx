    ...
    return(
        ...
        <main className="main">
          ...
          <div className="site-breadcrumb">
            <div className="container">
              <h2 className="breadcrumb-title">Manage Jobs</h2>
              <ul className="breadcrumb-menu">
                <li>
                  <a href="/">Home</a>
                </li>
                <li className="active">Manage Jobs</li>
              </ul>
            </div>
                ...
                <div className="col-lg-3">
                  <div className="user-profile-sidebar">
                    ...
                    <ul className="user-profile-sidebar-list">
                      ...
                      <li>
                        <a className="active" href="employer-manage-job">
                ...
                <div className="col-lg-9">
                  <div className="user-profile-card">
                    <div className="user-profile-card-header">
                      <h4 className="user-profile-card-title">Manage Jobs</h4>
                ...
                <div className="col-md-6 col-lg-4 col-xl-3">
                  <div className="footer-widget-box about-us">
                    ...
                    <ul className="footer-contact">
                      ...
                      <li>
                        <a href="/cdn-cgi/l/email-protection#e38a8d858ca3869b828e938f86cd808c8e">
                          <i className="far fa-envelope" />
                          <span
                            className="__cf_email__"
                            data-cfemail="137a7d757c53766b727e637f763d707c7e"
                          >
                            [email&nbsp;protected]
                          </span>
                        </a>
